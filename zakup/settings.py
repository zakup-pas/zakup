"""
Django settings for zakup project.
...
SECRET_KEY = 'django-insecure-=88m8_0w_&$ocsaw9xt+=1vp958h^rw%$ywh@+v+it7=vgj6i*'
...
WSGI_APPLICATION = 'zakup.wsgi.application'
...
DATABASES = {
    ...
    #'default': {
	   ...
	   # 'NAME': 'zakup_db',
	   # 'USER' : 'zakup_db_user',
	   # 'PASSWORD' : 'sFcQzg1inbZjJetLaUFh615FtKviNL49',
	   # 'HOST' : 'dpg-ckcevlciibqc73bjmgu0-a.oregon-postgres.render.com',
	   # 'PORT' : '5432',
    #}
